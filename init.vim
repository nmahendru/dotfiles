...
autocmd ColorScheme * highlight ExtraWhitespace ctermbg=black guibg=green

hi CocErrorSign  ctermfg=Red ctermbg=Black guifg=Red

hi CocWarningSign  ctermfg=Brown ctermbg=Black guifg=Blue

hi CocInfoSign  ctermfg=Yellow  ctermbg=Black guifg=Yellow
hi CocHintSign  ctermfg=Blue ctermbg=Black guifg=white
